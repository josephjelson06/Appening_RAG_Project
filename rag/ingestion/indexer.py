...
MANIFEST_PATH = PATHS.index_manifest_dir / "pinecone_manifest.json"
...
def main():
    ...
    chunks = load_chunks()
    if not chunks:
        raise RuntimeError("No chunks found. Run 03_build_chunks.py first.")
    ...
    PATHS.index_manifest_dir.mkdir(parents=True, exist_ok=True)
        ...
        json.dumps(
            {
                ...
                "embedding_dimension": len(first_embeddings[0]),
            },
            indent=2,
        ),
        encoding="utf-8",
